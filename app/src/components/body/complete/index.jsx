						...
						<div className='body-table-body' key={index}>
							...
							<div style={{ width: '25%' }}>
								<div className='body-table-button-container'>
									...
									<Link className='body-table-button-modify' onClick={_handleModify} to={`/modify?pid=${project.id}`}>수정하기</Link>
									<div className='body-table-button-delete' onClick={ () => _handleDelete(project.id) } >삭제하기</div>
								</div>
							</div>
						</div>
					)
